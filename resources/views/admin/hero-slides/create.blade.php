...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Hero Slide</h1>
...
<div class="card shadow">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Hero Slide</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.hero-slides.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('subtitle_id') is-invalid @enderror" 
                                  ...
                                  name="subtitle_id" 
                                  rows="3" 
                                  required>{{ old('subtitle_id') }}</textarea>
                        @error('subtitle_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="button_text_id" 
                                       name="button_text_id" 
                                       value="{{ old('button_text_id', 'Buat Janji Temu') }}" 
                                       maxlength="255">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="button_text_en" 
                                       name="button_text_en" 
                                       value="{{ old('button_text_en', 'Book Appointment') }}" 
                                       maxlength="255">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label for="image" class="form-label">Gambar Slide <span class="text-danger">*</span></label>
                        <input type="file" 
