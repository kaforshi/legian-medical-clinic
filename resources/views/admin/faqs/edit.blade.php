                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" 
                            ...
                            <option value="medical" {{ old('category', $faq->category) == 'medical' ? 'selected' : '' }}>Medis</option>
                            <option value="appointment" {{ old('category', $faq->category) == 'appointment' ? 'selected' : '' }}>Janji Temu</option>
                            <option value="payment" {{ old('category', $faq->category) == 'payment' ? 'selected' : '' }}>Pembayaran</option>
                            <option value="facility" {{ old('category', $faq->category) == 'facility' ? 'selected' : '' }}>Fasilitas</option>
                        </select>
                        @error('category')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
