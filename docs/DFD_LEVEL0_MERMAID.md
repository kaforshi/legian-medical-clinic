# DFD Level 0 - Sistem Website Legian Medical Clinic (Mermaid)
...
- **Data Store:** Dua garis horizontal paralel (open-ended rectangle) dengan label D1, D2, dst.
...
graph TB
    ...
    %% Processes
    P1["P1.0<br/>Login"]
    P2["P2.0<br/>Manajemen<br/>Dokter"]
    P3["P3.0<br/>Manajemen<br/>Layanan"]
    P4["P4.0<br/>Manajemen<br/>FAQ"]
    P5["P5.0<br/>Manajemen<br/>Konten"]
    P6["P6.0<br/>Manajemen<br/>User"]
    P7["P7.0<br/>Pengaturan<br/>Akun"]
    P8["P8.0<br/>Auto-Translation"]
    P9["P9.0<br/>Tampilkan<br/>Website"]
    P10["P10.0<br/>Manajemen<br/>Hero Slides"]
...
**Input:**
- `data teks bahasa Indonesia` dari P2.0, P3.0, P4.0, P5.0, P10.0
- `info teks terjemahan` dari Google Translate API

**Output:**
- `info teks terjemahan` ke P2.0, P3.0, P4.0, P5.0, P10.0
...
- P10.0 (Manajemen Hero Slides) - menulis
