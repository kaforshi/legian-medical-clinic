# DFD Level 1 - Sistem Website Legian Medical Clinic (Mermaid)
...
#### P1.3 Logout
**Deskripsi:** Proses untuk logout dan menghapus session.

**Input:**
- `request logout` dari Super Admin/Admin

**Output:**
- `konfirmasi logout` ke Super Admin/Admin
- `hapus session` ke D7 (sessions)
- `data log aktivitas` ke D6 (activity_logs)
...
Sub-proses: P3.1 Tambah, P3.2 Ubah, P3.3 Hapus, P3.4 Validasi (sama seperti P2.0 dengan data layanan)

---

### P4.0 Manajemen FAQ

Sub-proses: P4.1 Tambah, P4.2 Ubah, P4.3 Hapus, P4.4 Validasi (sama seperti P2.0 dengan data FAQ)

---

### P5.0 Manajemen Konten

Sub-proses: P5.1 Tambah, P5.2 Ubah, P5.3 Hapus, P5.4 Validasi (sama seperti P2.0 dengan data konten)

---

### P6.0 Manajemen User

Sub-proses: P6.1 Tambah, P6.2 Ubah, P6.3 Hapus, P6.4 Validasi (sama seperti P2.0 dengan data user admin, hanya Super Admin)

---

### P7.0 Pengaturan Akun

Sub-proses: P7.1 Ubah Username, P7.2 Ubah Password, P7.3 Validasi Pengaturan Akun
...
Sub-proses: P10.1 Tambah, P10.2 Ubah, P10.3 Hapus, P10.4 Validasi (sama seperti P2.0 dengan data hero slide)
